...
class ItemStock extends Component {
    ...
    fetchData = async () => {
        ...
        const response = await fetch('http://localhost:1348/perfil');
        const response1 = await fetch('http://localhost:1348/personal');
    ...
    UpdateData = async () => {
        ...
        const response = await fetch('http://localhost:1348/perfiledit',options);
        ...
        return (
            <View>
                <View style={styles.columna}>
                    ...
                    <Text style={styles.texto}> {this.state.personal.first_name} {this.state.personal.last_name} <br /> {this.state.especialidad.especialidad}</Text>
                </View>
                ...
                <TextInput onChangeText={(text) => this.setState({ email: text })} style={styles.input1} defaultValue={this.state.personal.email}></TextInput>
